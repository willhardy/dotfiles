...
# Change to the directory of the given python module
function cdp () {
...
# Enable powerline if it exists
POWERLINE_DIR="$(python -c "import os.path as _, powerline; \
          print _.dirname(_.realpath(powerline.__file__[:-1]))"
    )"
